...
{
    //QString base = "https://maps.googleapis.com/maps/api/directions/json?origin=-31.4236,-64.1794&destination=-31.425418,%20-64.183345&key=AIzaSyC5B1slkQH2LvD3kB3Ifsin47Tex52cri0";
...
void DataManager::getMap(QList<QString> coords)
{
    ...
    QString params = "&size=640x640&zoom=16&path=";
